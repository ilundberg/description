...
\begin{frame}{Concrete exercise: Sex gap in pay}
\begin{tabular}{ll}
...
\begin{frame}{Implications of a $\hat{Y}$ view of description}
\pause
\begin{itemize}
...
\begin{frame}{With $\hat{Y}$ description,\\machine learning becomes a plug-in}
